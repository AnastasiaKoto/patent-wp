		...
		<div class="footer__content flex">
			<div class="footer__group flex">
				...
				<div class="footer__descr">
					...
					разглашены и не будут переданы третьим лицам.
				</div>
			</div>
								...
								<a href="<?php echo get_sub_field('tg_link'); ?>">
									<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<path
											...
											fill="white" />
										<defs>
											<linearGradient id="paint0_linear_846_2123" x1="24" y1="0" x2="24" y2="47.6438"
							...
							<?php if (get_sub_field('fc_link')) { ?>
								<a href="<?php echo get_sub_field('fc_link'); ?>">
									<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<path
											d="M25.6029 39.9998V25.4031H30.5025L31.236 19.7145H25.6029V16.0825C25.6029 14.4356 26.0603 13.3131 28.4223 13.3131L31.4346 13.3117V8.22391C30.9134 8.15484 29.1254 8 27.0451 8C22.702 8 19.7286 10.6509 19.7286 15.5194V19.7147H14.8164V25.4033H19.7285V40L25.6029 39.9998Z"
											fill="white" />
									</svg>
								</a>
							<?php } ?>
...
<div class="to_top">
	<svg xmlns="http://www.w3.org/2000/svg" width="73" height="73" viewBox="0 0 73 73" fill="none">
		...
		<path
			d="M37.7071 24.2929C37.3166 23.9024 36.6834 23.9024 36.2929 24.2929L29.9289 30.6569C29.5384 31.0474 29.5384 31.6805 29.9289 32.0711C30.3195 32.4616 30.9526 32.4616 31.3431 32.0711L37 26.4142L42.6569 32.0711C43.0474 32.4616 43.6805 32.4616 44.0711 32.0711C44.4616 31.6805 44.4616 31.0474 44.0711 30.6569L37.7071 24.2929ZM38 42L38 25L36 25L36 42L38 42Z"
			fill="#1E1D25" />
		<defs>
			<filter id="filter0_d_762_4916" x="0.5" y="0.5" width="72" height="72" filterUnits="userSpaceOnUse"
