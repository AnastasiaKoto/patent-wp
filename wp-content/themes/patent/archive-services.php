...
<main class="main">
                                        ...
                                        <div class="serv__header-block flex">
                                            ...
                                            <div class="titles__wrapp">
                                                ...
                                                <div class="small__price">
                                                    <span>
                                                        <?php echo get_field('arch-price', 'services_category_' . $children->term_id); ?>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="orfer-form__wrapper-gray   <? if(is_archive()){ echo 'orfer-form__wrapper-gray_archive';}?>">
