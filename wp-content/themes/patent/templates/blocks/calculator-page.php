                ...
                <div class="calculator__wrapper">
                    <div class="calculator__inner">
                        <div class="calculator__type">
                            ...
                            <label class="">
                                <input type="radio" name="wordmark_option" value="12000">
                                Изобразительный
                            </label>
                            <label class="">
                                <input type="radio" name="wordmark_option" value="23000">
                                Комбинированный
                            </label>
                        </div>
                    ...
                    <div class="calculator__inner calculator__inner-2">
                        ...
                        <div class="section-mkty__tabs section-mkty-tabs section-mkty-tabs-styles">
                            ...
                            <div class="section-mkty-tabs__item section-mkty-tabs-item" id="mkty-tabs-item_1">
                                ...
                                <div class="section-mkty-tabs-item__number">
                                    <div class="section-mkty-tabs-item__name"> </div>
                                </div>
                                <div class="section-mkty-tabs-item__data">
