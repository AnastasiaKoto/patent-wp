...
?>
    <main class="main">
            ...
            <div class="container">
                ...
                <div class="banner__content flex">
                    <div class="banner__block">
                        <h1 class="title banner-services__title">аннулирование товарного знака по неиспользованию</h1>
        ...
        <section class="article-box">
            <div class="container">
                <div class="article-box__wrapper">
                    <h2 class="article-box__title">Заголовок</h2>
                    <div class="article-box__text">
                        Равным образом консультация с широким активом требуют от нас анализа форм развития. Таким
                        образом рамки и место обучения кадров играет важную роль в формировании системы обучения кадров,
        ...
        <section class="prices prices-pt0">
            <div class="container">
                <h2 class="titles">стоимость</h2>
                <div class="prices-subtitle">
                    <h3 class="prices-subtitle__title">На стороне заявителя</h3>
                    <div class="prices-subtitle__text">Равным образом консультация с широким активом требуют от нас
                        анализа форм развития. Таким образом рамки и место обучения кадров играет важную роль в
        ...
        <section class="points  prices-pt0">
            <div class="container">
                ...
                <div class="points__wrapper points__wrapper-tp0">
                    <ul class="points__list">
                        ...
                        <li class="points__item">
                            ...
                            <svg width="12" height="8" viewBox="0 0 12 8" fill="none"
                              ...
                              <path d="M1 1.28418L6 6.28418L11 1.28418" stroke="white" stroke-width="2"
        ...
        <section class="prices prices-pt0">
            <div class="container">
                <div class="prices-subtitle">
                    ...
                    <div class="prices-subtitle__text">Равным образом консультация с широким активом требуют от нас анализа форм развития. Таким образом рамки и место обучения кадров играет важную роль в формировании системы обучения кадров, соответствует насущным потребностям.
                    </div>
                </div>
        ...
        <section class="discounts discounts-tp0">
            <div class="container">
                <div class="discounts__wrapper">
                    <div class="discounts__inner discounts__inner--sb">
                        ...
                        <p class="discounts__text"><span>Договор предусматривает</span> контроль и уведомление клиента о
                            ситуации на каждом этапе регистрации</p>
                        <p class="discounts__text"><span>При последовательной оплате</span> мы пройдем все этапы и
                            зарегистрируем товарный знак.</p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="points-slider">
                    <div class="points-slider__inner">
                        ...
                        <p class="points-slider__text">Не беспокойтесь в 1-3 консультации Мы разберемся даже с очень
                            сложным вопросом. Компания получит надежную регистрацию бренда.</p>
                    </div>
                    ...
                    <li class="approach__item">
                        <div class="approach__img">
                            <svg width="33" height="33" viewBox="0 0 33 33" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M30.2 19.8L27.2 16.8C26.8 16.4 26.2 16.4 25.8 16.8L16.5 26.1V30.5H20.9L30.2 21.2C30.6 20.8 30.6 20.2 30.2 19.8ZM20.1 28.5H18.5V26.9L23.5 21.9L25.1 23.5L20.1 28.5ZM26.5 22.1L24.9 20.5L26.5 18.9L28.1 20.5L26.5 22.1ZM10.5 23.5H12.5V25.5H10.5V23.5ZM14.5 18.5H18.5V20.5H14.5V18.5ZM10.5 18.5H12.5V20.5H10.5V18.5ZM14.5 13.5H22.5V15.5H14.5V13.5ZM10.5 13.5H12.5V15.5H10.5V13.5Z"
                                      fill="#1E1D25"/>
                                <path d="M7.5 28.5V7.5H10.5V10.5H22.5V7.5H25.5V13.5H27.5V7.5C27.5 6.4 26.6 5.5 25.5 5.5H22.5V4.5C22.5 3.4 21.6 2.5 20.5 2.5H12.5C11.4 2.5 10.5 3.4 10.5 4.5V5.5H7.5C6.4 5.5 5.5 6.4 5.5 7.5V28.5C5.5 29.6 6.4 30.5 7.5 30.5H12.5V28.5H7.5ZM12.5 4.5H20.5V8.5H12.5V4.5Z"
                                      fill="#1E1D25"/>
                            </svg>
                        </div>
                                ...
                                <defs>
                                    <clipPath id="clip0_550_2934">
                                        <rect width="24" height="23.9995" fill="white"
                                              transform="translate(0.5 0.500488)"/>
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
                        ...
                        <div class="approach__img">
                            <svg width="23" height="23" viewBox="0 0 23 23" fill="none"
                                ...
                                <g clip-path="url(#clip0_550_2937)">
                                    <path d="M2.87305 4.43495L11.5022 1.9165L20.1227 4.43495V9.5993C20.1226 12.246 19.2898 14.8256 17.7421 16.9726C16.1943 19.1197 14.0103 20.7252 11.4993 21.5619C8.98754 20.7254 6.80275 19.1196 5.2545 16.9721C3.70626 14.8246 2.87309 12.2443 2.87305 9.5969V4.43495Z"
                                          stroke="#1E1D25" stroke-width="1.91663" stroke-linejoin="round"/>
                                    <path d="M7.18555 11.0203L10.5396 14.3744L16.2895 8.62451" stroke="#1E1D25"
                                          stroke-width="1.91663" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                                <defs>
            ...
            <div class="container">
                ...
                <ul class="what__list">
                    <li class="what__item">
                        ...
                        <svg class="what__svg" width="23" height="12" viewBox="0 0 23 12" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="container">
                <div class="article-box__wrapper">
                    ...
                    <div class="article-box__text">
                        ...
                        образом рамки и место обучения кадров играет важную роль в формировании системы обучения кадров,
                        соответствует насущным потребностям. С другой стороны постоянный количественный рост и сфера
                        нашей активности играет важную роль в формировании существенных финансовых и административных
                        условий. Равным образом консультация с широким активом требуют от нас анализа форм развития.
                        Таким образом рамки и место обучения кадров играет важную роль в формировании системы обучения
                        кадров, соответствует насущным потребностям. С другой стороны постоянный количественный рост и
                        сфера нашей активности играет важную роль в формировании существенных финансовых и
            ...
            <div class="container">
                ...
                <ul class="interesting__list">
                    <li class="interesting__item">
                        ...
                        <h3 class="interesting__title">качество поиска товарных знаков исключает риски отказа
                            регистрации</h3>
                        <div class="interesting__text">Равным образом консультация с широким активом требуют от нас
                            анализа форм...
                        </div>
                    </li>
